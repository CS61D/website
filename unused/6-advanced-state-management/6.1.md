...
It is a regular JavaScript object. You can put any fields you’d like in there, but the convention is to give it a **string type that describes _what happened_**. (You will add the dispatch function itself in a later step.)
